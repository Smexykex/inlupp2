...
void edit_merch(merch_t *merch)
{
  ...
  char *confirmation = ask_question_string("Do you want edit %s, type 'y' for yes ");
...
// TODO
void move_item(ioopm_hash_table_t *merch_data_base)
{
  return;
}
...
void remove_item_from_db(ioopm_hash_table_t *merch_data_base)
{
  ...
  do
  {
    ...
    retrived_value = ioopm_hash_table_lookup(merch_data_base, (elem_t) { .str = merch_to_remove });
  } 
  while (retrived_value == NULL);

  char *confirmation = ask_question_string("Do you want delete %s, type 'y' for yes ");
...
// TODO
void show_stock(ioopm_hash_table_t *db)
{
  puts("Not yet implemented!");
}

// TODO
void replenish_stock(ioopm_hash_table_t *db)
{
  puts("Not yet implemented!");
}
